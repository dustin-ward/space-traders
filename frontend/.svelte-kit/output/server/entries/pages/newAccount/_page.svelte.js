...
const Input = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Wrapper, "Wrapper").$$render(
    ...
    {
      default: () => {
        return `${$$slots.left ? `<div class="${escape(twMerge(floatClass, $$props.classLeft), true) + " left-0 pl-2.5 pointer-events-none"}">${slots.left ? slots.left({
  ...
  `}
  ${$$slots.right ? `<div class="${escape(twMerge(floatClass, $$props.classRight), true) + " right-0 pr-2.5"}">${slots.right ? slots.right({
          props: { ...$$restProps, class: inputClass }
        }) : ``}</div>` : ``}`;
      }
    }
...
const ArrowLeft = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<svg${spread(
    ...
    {}
  )}>${variation === "outline" ? `<path d="M10.5 19.5L3 12M3 12L10.5 4.5M3 12H21"${add_attribute("stroke", color, 0)}${add_attribute("stroke-width", strokeWidth, 0)} stroke-linecap="round" stroke-linejoin="round"></path>` : `${variation === "mini" ? `<path fill-rule="evenodd" clip-rule="evenodd" d="M17 10C17 10.4142 16.6642 10.75 16.25 10.75L5.61208 10.75L9.76983 14.7094C10.0684 14.9965 10.0777 15.4713 9.79062 15.7698C9.50353 16.0684 9.02875 16.0777 8.73017 15.7906L3.23017 10.5406C3.08311 10.3992 3 10.204 3 10C3 9.79599 3.08311 9.60078 3.23017 9.45938L8.73017 4.20938C9.02875 3.92228 9.50353 3.93159 9.79062 4.23017C10.0777 4.52875 10.0684 5.00353 9.76983 5.29063L5.61208 9.25L16.25 9.25C16.6642 9.25 17 9.58579 17 10Z"${add_attribute("fill", color, 0)}></path>` : `<path fill-rule="evenodd" clip-rule="evenodd" d="M11.0303 3.96967C11.3232 4.26256 11.3232 4.73744 11.0303 5.03033L4.81066 11.25H21C21.4142 11.25 21.75 11.5858 21.75 12C21.75 12.4142 21.4142 12.75 21 12.75H4.81066L11.0303 18.9697C11.3232 19.2626 11.3232 19.7374 11.0303 20.0303C10.7374 20.3232 10.2626 20.3232 9.96967 20.0303L2.46967 12.5303C2.17678 12.2374 2.17678 11.7626 2.46967 11.4697L9.96967 3.96967C10.2626 3.67678 10.7374 3.67678 11.0303 3.96967Z"${add_attribute("fill", color, 0)}></path>`}`}</svg>
  ...
  do {
    ...
    $$rendered = `${validate_component(Button, "Button").$$render(
      $$result,
      {
        href: "/",
        outline: true,
        class: "p-2 absolute top-5 left-8"
      },
      {},
      {
        default: () => {
          return `${validate_component(ArrowLeft, "ArrowLeft").$$render($$result, { size: "24" }, {}, {})}`;
        }
      }
    )}
<div class="flex h-screen">${validate_component(Card, "Card").$$render(
      $$result,
      {
      ...
      {},
      {
		...
		<div class="create-form container mx-auto flex flex-col"><form>${validate_component(Label, "Label").$$render(
            $$result,
            {
              for: "callsign",
              class: "text-2xl text-left mb-4"
            },
            {},
            {
              default: () => {
