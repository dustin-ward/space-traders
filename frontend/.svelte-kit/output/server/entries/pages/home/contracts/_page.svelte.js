import { c as create_ssr_component, b as compute_rest_props, s as setContext, j as add_attribute, d as spread, h as escape_object, f as escape_attribute_value, g as getContext, n as is_void, a as subscribe, v as validate_component, o as each, e as escape } from "../../../../chunks/index2.js";
import { T as TOKEN } from "../../../../chunks/store.js";
...
${validate_component(Table, "Table").$$render($$result, {}, {}, {
	...
	${validate_component(TableBody, "TableBody").$$render($$result, {}, {}, {
        default: () => {
          return `${each(contracts, (contract) => {
            return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
              default: () => {
                return `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(contract.faction)}`;
                  }
                })}
				${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(contract.type)}`;
                  }
                })}
				${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(contract.terms.payment.onAccepted + contract.terms.payment.onFulfilled)}`;
                  }
                })}
				${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(contract.expiration)}`;
                  }
                })}
				${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
                  default: () => {
                    return `${escape(contract.accepted)}`;
                  }
                })}
			`;
              }
